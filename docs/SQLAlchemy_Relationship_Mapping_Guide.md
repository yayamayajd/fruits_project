...
|-------------------|-------------------|---------------------------|----------------------------------------------------|
| Many-to-Many      | ✅ Required       | Two FKs in association table | Used in **both** parent tables with `secondary`     |
| One-to-Many       | ❌ Not Required   | In child table             | Used in **parent** with `back_populates`           |
| Many-to-One       | ❌ Not Required   | In child table             | Used in **child** with `back_populates`            |
| One-to-One        | ❌ Not Required   | In child (`unique=True`)   | Used in **both** tables with `back_populates`      |
